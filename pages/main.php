...
<style>
  ...
  .carousel-item img {
    object-fit: cover; /* Hiển thị toàn bộ hình ảnh */
...
<div class="tien_ich  container">
      ...
      <div class="col-xs-2">
        ...
        <p class="bold mt15">Dễ dàng tìm kiếm chuyến bay</p>
      ...
      <div class="col-xs-2">
        ...
        <p class="bold mt15">Thanh toán nhanh chóng</p>
      ...
      <div class="col-xs-2">
        ...
        <p class="bold mt15">Hỗ trợ đặt vé máy bay 24/7</p>
      ...
      <div class="col-xs-2">
        ...
        <p class="bold mt15">Săn vé máy bay giá rẻ</p>
