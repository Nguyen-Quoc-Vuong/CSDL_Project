<?php 
    $sql_lietke_danhmucsp = "SELECT * FROM cities order by id"; 
      ...
      ?>
          <tr>
              ...
              <td>
                  ...
                  <a href="modules/quanlicity/xuly.php?id=<?php echo $row['id'] ?>" class="btn btn-danger" onclick="return confirm('Bạn có chắc chắn muốn xóa không?')">Xóa</a>
