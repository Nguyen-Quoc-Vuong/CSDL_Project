...
<html lang="en">
  ...
  <body>
    ...
    <header>
           <div class ="logo">
            <img src="../asset/img/VNA_logo_vn.webp" style="height: 80px">
            <img src="../asset/img/skyteam.webp" style="height: 40px; width: 50px ;margin-top : 15px">
           </div>
           <div class = "menu">
            <li>Thông tin hành trình</li>
            <li>Mua vé và sản phẩm khác</li>
           </div>
           <div class = "others">
            <li><i class="bi bi-search"></i>Đăng nhập</li>
            <li></li>
           </div>
